            ...
            <div class="modal-content">
                ...
                <div class="modal-body">                  
                    <div class="form-group">
					    ...
					    <label class="col-sm-3">{{ \Lang::has('redprint::strings.height') ? trans('redprint::strings.height') :  'Height' }} </label>
					    ...
					    <label class="col-sm-3">{{ \Lang::has('redprint::strings.contact') ? trans('redprint::strings.contact') :  'Contact' }} </label>
					    ...
					    <label class="col-sm-3">{{ \Lang::has('redprint::strings.plan') ? trans('redprint::strings.plan') :  'Plan' }} </label>

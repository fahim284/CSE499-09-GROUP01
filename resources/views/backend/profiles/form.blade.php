...
<div class="form-group col-md-6 col-xs-6 col-lg-6  has-feedback {{ $errors->has('user_id') ? 'has-error' : '' }}">
  ...
  @endif
</div>                <div class="form-group has-feedback col-xs-4 col-md-4 col-lg-4 {{ $errors->has('height') ? 'has-error' : '' }}">
            <label>Height</label>
        ...
        <div class="form-group has-feedback col-xs-4 col-md-4 col-lg-4 {{ $errors->has('weight') ? 'has-error' : '' }}">
            <label>Weight</label>
        ...
        <div class="form-group has-feedback col-xs-5 col-md-5 col-lg-5 {{ $errors->has('gender') ? 'has-error' : '' }}">
            <label>Gender</label>
        ...
        <div class="form-group has-feedback col-xs-6 col-md-6 col-lg-6 {{ $errors->has('contact') ? 'has-error' : '' }}">
            <label>Contact</label>
        ...
        <div class="form-group has-feedback col-xs-6 col-md-6 col-lg-6 {{ $errors->has('plan') ? 'has-error' : '' }}">
            <label>Plan</label>
    ...
    <div class="form-group has-feedback col-xs-6 col-md-6 col-lg-6 {{ $errors->has('avatar') ? 'has-error' : '' }}">

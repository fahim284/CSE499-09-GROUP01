    ...
    <div class="col-md-6">
        ...
        <form method="post" action="{{ route("profiles.save") }}" class="form-horizontal">
            ...
            <div class="form-group">
                <label style="color:#151512;">Height: </label>
            ...
            <div class="form-group">
                <label style="color:#151512;">Weight: </label>
            ...
            <div class="form-group">
                <label style="color:#151512;">Age: </label>
            ...
            <div class="form-group">
                <label style="color:#151512;">Gender: </label>
            ...
            <div class="form-group">
                <label style="color:#151512;">Contact: </label>
            ...
            <div class="form-group" style="color:#151512;">
                <label>Plan: </label> <br />

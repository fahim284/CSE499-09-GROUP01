...
@section("content")
    <h3 style="color:#151512;">Welcome {{ $user->name }} To Your Account</h3>
    <hr />

    <h4 style="color:#151512;">{{ $message }}</h4> </br></br>
    <h4 style="color:#151512;">Your TDEE Is {{ $bmr }}</h4></br></br>
    <h4 style="color:#151512;">Your Suggested Calorie {{ $suggested_bmr }}</h4></br></br>
